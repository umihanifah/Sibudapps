...
class ScannBarcode extends StatelessWidget {
  ScannBarcode({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 0.0, end: 0.0),
            Pin(start: 63.0, end: 80.9),
            child:
                // Adobe XD layer: '05_nli_qr_codenjnhj' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/barcode.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Pinned.fromPins(
            Pin(start: -9.0, end: -25.0),
            Pin(size: 104.0, end: -30.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 32.0, start: 45.5),
            Pin(size: 38.7, end: 29.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 120.0, start: 4.0),
            Pin(size: 56.0, end: 22.0),
            child: PageLink(
              links: [
                PageLinkInfo(
          ...
          Pinned.fromPins(
            Pin(size: 20.7, middle: 0.4913),
            Pin(size: 20.7, end: 47.0),
            child:
