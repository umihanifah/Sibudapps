      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 57.0, start: 63.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0x2b777371),
                boxShadow: [
                  BoxShadow(
                    color: const Color(0x270d0b08),
                    offset: Offset(0, 7),
                    blurRadius: 8,
                  ),
                ],
          ...
          Pinned.fromPins(
            Pin(size: 18.0, middle: 0.7591),
            Pin(size: 9.0, start: 87.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 140.0, start: 33.0),
            Pin(size: 154.0, middle: 0.234),
            child: Component11(),
          ),
          Pinned.fromPins(
            Pin(size: 140.0, start: 34.0),
            Pin(size: 154.0, middle: 0.5517),
            child: Component11(),
          ),
          Pinned.fromPins(
            Pin(size: 140.0, end: 34.0),
            Pin(size: 154.0, middle: 0.5517),
            child: Component11(),
          ),
          Pinned.fromPins(
            Pin(size: 140.0, start: 34.0),
            Pin(size: 154.0, end: 86.0),
            child: Component11(),
          ),
          Pinned.fromPins(
            Pin(size: 140.0, end: 34.0),
          ...
          Pinned.fromPins(
            Pin(size: 135.0, end: 39.0),
            Pin(size: 12.0, middle: 0.3925),
            child: Text(
              'Kota Tua sebagai warisan bidaya...',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
          ...
          Pinned.fromPins(
            Pin(size: 139.0, start: 33.0),
            Pin(size: 12.0, middle: 0.3925),
            child: Text(
              'Landmark favorit para turis dan fo..',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            Pin(size: 139.0, start: 34.0),
            Pin(size: 12.0, middle: 0.6538),
            child: Text(
              'Candi Borobudur masuk kedalam ..',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            Pin(size: 136.0, end: 38.0),
            Pin(size: 12.0, middle: 0.6538),
            child: Text(
              'Kisah Sangiran, situs manusia pur..',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            ...
            child: Text(
              'Mengenal habitat komodo dipulau..',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            Pin(size: 139.0, end: 35.0),
            Pin(size: 12.0, end: 68.0),
            child: Text(
              'Candi Prambanan dibangun pada.. ',
              style: TextStyle(
                fontFamily: 'Adam',
                fontSize: 9,
                color: const Color(0xff000000),
...
const String _svg_nsda67 =
    '<svg viewBox="271.0 87.0 18.0 9.0" ><path transform="translate(262.0, 73.5)" d="M 9 13.5 L 18 22.5 L 27 13.5 L 9 13.5 Z" fill="#59381f" fill-opacity="0.54" stroke="none" stroke-width="1" stroke-opacity="0.54" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
